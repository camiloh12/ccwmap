...
| 8+ | **National rollout (separate project)** | Categorical waves nationwide: federal → K-12 → airports + colleges → OSM. Each wave needs state-law table extended to all 50 states. | TBD per wave | TBD |
